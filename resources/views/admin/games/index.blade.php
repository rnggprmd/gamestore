...
<div id="modal-create-game" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4">
    ...
    <div class="admin-modal-content">
        ...
        <form action="{{ route('admin.games.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col flex-1 min-h-0">
            @csrf
...
<div id="modal-edit-game" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4">
    ...
    <div class="admin-modal-content">
        ...
        <form id="form-edit-game" action="" method="POST" enctype="multipart/form-data" class="flex flex-col flex-1 min-h-0">
            @csrf @method('PUT')
